...
to_download = "_translated_cds.faa.gz"
date = "20230208"

path2download = "../../data/"
path2download_dir = path2download + date + "_" + sp_id + "_faa"
...
data.to_csv(path2download + date + "_info." + sp_id + "_translated_cds.csv")       ## save meta data
